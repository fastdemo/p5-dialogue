  ...
  useEffect(() => {
    ...
    switch (boxType) {
      ...
      case 'noPortrait': {
        ...
        if (boxType === 'main') {
          ...
          if (charWithBox && (font === 'KoreanKRSM' || font === 'Optima nova LT')) {
            ...
            setBox(`./generators/P5/images/boxes/db-${charWithBox}-${font}.png`)
            return;
          } else {  
            // If not, draw a blank box depending on the size of the name.
            if (nameObj.width <= 195) { setBoxSize('small'); setBox('./generators/P5/images/db-main-small.png'); textX = 418; }
            else if (nameObj.width > 195 && nameObj.width <= 275) { setBoxSize('medium'); setBox('./generators/P5/images/db-main-medium.png'); textX = 456; }
            else { setBoxSize('large'); setBox('./generators/P5/images/db-main-large.png'); textX = 495; }
          }
        } else {
          setBox('./generators/P5/images/db-noPortrait.png');
        }
      ...
      case 'dancing': {
        ...
        setBox('./generators/P5/images/db-dancing.png');
        break;
      }
      ...
      case 'strikers': {
        ...
        setBox('./generators/P5/images/db-strikers.png');
        break;
      }
    }
  }, [name, font, boxType])
